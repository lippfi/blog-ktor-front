export default {
    ...
    userAvatar: {
        ...
        dialog: {
            addFriend: {
                ...
                labelInfo: 'Дос белгісі дос тізіміңіздегі адамды қалай жіктейтініңізді көрсетеді. Бұл белгі достарыңызды қарайтын басқа пайдаланушыларға көрінеді. Ол қарым-қатынасты сипаттай алады, мысалы: сүйіктіңіз, ойын серіктесі және т.б.',
            ...
            block: {
                ...
                reasonPlaceholder: 'Бұғаттау себебі',
                hideFromFeed: {
    ...
    notificationItem: {
        ...
        from: '{user} жіберді',
        friendRequestText: '{nickname} сізге достық сұранысын жіберді',
        friendRequestAccept: 'Досқа қосу',
        friendRequestDecline: 'Қабылдамау',
        friendRequestAcceptSuccess: 'Достық сұранысы қабылданды',
        friendRequestAcceptError: 'Достық сұранысын қабылдау сәтсіз аяқталды',
        friendRequestDeclineSuccess: 'Достық сұранысы қабылданбады',
        friendRequestDeclineError: 'Достық сұранысын қабылдамау сәтсіз аяқталды',
