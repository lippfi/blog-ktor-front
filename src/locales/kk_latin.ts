export default {
    ...
    onsiteNotificationSettings: {
        loadError: 'Xabarlama parametrlerin júkteu sátsiz ayaqtaldy',
        saveError: 'Xabarlama parametrlerin janartu sátsiz ayaqtaldy',
        save: 'Saqtau',
        cancel: 'Boldyrmau',
        notifyAboutComments: 'Meniń jazbalarymа pikirler',
        notifyAboutReplies: 'Meniń pikirlerime jauaptar',
        notifyAboutPostReactions: 'Meniń jazbalarymа reakciyalar',
        notifyAboutCommentReactions: 'Meniń pikirlerime reakciyalar',
        notifyAboutPrivateMessages: 'Jeke xabarlamalar',
        notifyAboutMentions: 'Jazbalardag\'y atalular',
        notifyAboutNewPosts: 'Jazylymdardan jaña jazbalar',
        notifyAboutFriendRequests: 'Dostyq suranysdar',
        notifyAboutReposts: 'Reposttar',
        notifyAboutCommentMentions: 'Pikirlerdegi atalular',
    },
    styles: {
