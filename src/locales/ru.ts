export default {
    ...
    userAvatar: {
        ...
        dialog: {
            addFriend: {
                ...
                labelInfo: 'Метка друга показывает, как вы классифицируете человека в списке друзей. Эта метка видна другим пользователям, которые просматривают ваших друзей. Она может описывать ваши отношения, например: вторая половинка, напарник по игре и т.д.',
    ...
    notificationItem: {
        ...
        from: 'От {user}',
        friendRequestText: '{nickname} отправил(а) вам заявку в друзья',
        friendRequestAccept: 'Добавить в друзья',
        friendRequestDecline: 'Отклонить',
        friendRequestAcceptSuccess: 'Заявка в друзья принята',
        friendRequestAcceptError: 'Не удалось принять заявку в друзья',
        friendRequestDeclineSuccess: 'Заявка в друзья отклонена',
        friendRequestDeclineError: 'Не удалось отклонить заявку в друзья',
